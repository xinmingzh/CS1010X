...
def tree(n, bb):
    ...
    if n == 1:
        ...
        return overlay_frac((n-1)/n, tree(n-1, scale((n-1)/n, bb)), bb)
...
def helix(bb, n):
    ...
    def helix_x(bb, a):
        if a == 1:
            return helix_layer(0)
        else:
            return overlay_frac((a-1)/a, helix_x(bb, a-1), helix_layer(a-1))
    return helix_x(bb_scaled, n)
